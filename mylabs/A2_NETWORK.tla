...
vars == <<NodeWorking, Network, TerminationDetected>>
...
DetectTermination == 
\* This isn't implementable: TerminationDetected must be inferred by the system, can't be "Terminated" which is a property of the system
...
Spec ==
    ...
    \* Enables fairness over vars, ensuring all states are explored if available.
====
